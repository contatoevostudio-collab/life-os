    ...
    <header className="glass-panel sticky top-4 z-30 flex min-h-16 flex-col gap-3 rounded-[24px] px-4 py-3 md:px-5 lg:flex-row lg:items-center lg:justify-between">
      <div className="flex min-w-0 items-center gap-3">
        ...
        <div className="min-w-0">
          <p className="text-xs uppercase tracking-[0.24em] text-text-muted">Hoje</p>
      ...
      <div className="flex w-full items-center justify-end gap-2 lg:w-auto">
        ...
        <div className="flex min-w-0 items-center gap-2 rounded-[16px] border border-border px-3 py-2">
